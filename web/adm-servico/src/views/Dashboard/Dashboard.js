        ...
        <Row>
          <Col>
            <Card>
              <CardHeader>
                Mesas/Atendimento
                <Button color="primary" className="float-right align-middle" size="sm" onClick={() => {
                  alert('add mesa')
                }}><span className={'fa fa-plus'}></span>&nbsp;Add Mesa</Button>
              </CardHeader>
              <CardBody>
                        ...
                        <Col xs="6" sm="6" lg="3">
                          <Widget04
                            ...
                            children={mesa.comandas.length > 1 ?
                              mesa.comandas.reduce((a, b) => a.total || a + b.total) : mesa.comandas[0].total}
                            invert={true}
                          >
                          </Widget04>
                        </Col>
